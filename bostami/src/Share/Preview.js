    ...
    <>
      ...
      <section className="bg-previewBg bg-no-repeat bg-center  bg-cover">
        <div className="text-center pt-[100px] pb-[90px] h-[80vh] md:h-[100vh] flex items-center justify-center flex-col">
          ...
          >
            ...
            <span className="text-theme-primary">Tailwind CSS</span> &{" "}
            <span className="text-theme-primary">React JS</span>
          </p>

          <div className="flex mt-6 justify-center">
            <a
              href="#demo"
              className="flex-shrink-0 inline-flex mr-3 items-center justify-center px-5 md:px-8 py-3 md:py-4 text-sm md:text-base font-semibold leading-6 text-white gradient-theme gradient-theme-hover rounded-full shadow-md"
            >
              View Demos
              <svg
      ...
      >
        <div className="container px-4 lg:px-0 text-center mb-[100px] pt-[80px]">
          <h1 className="text-theme-primary text-[32px] md:text-[45px] font-semibold ">
            Home Demo
          </h1>
        ...
        <div className=" container px-4 lg:px-0 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-[100px] ">
          ...
          {features.map((item) => (
            ...
            >
              ...
              <p className="text-[var(--color-text-muted)] transition-all duration-300 ease-linear mt-3 group-hover:text-[var(--color-emphasis)] ">
                {item?.description}
              </p>
            </div>
          ))}
      ...
      <section className="text-center bg-[#000] py-[120px] ">
        ...
        >
          ...
          <span className="text-theme-primary">React JS</span> &{" "}
          <span className="text-theme-primary">Tailwind CSS</span> Portfolio
          Template.
        </p>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-shrink-0 inline-flex mt-8 items-center justify-center px-5 md:px-8 py-3 md:py-4 text-sm md:text-base font-semibold leading-6 text-white gradient-theme gradient-theme-hover rounded-full shadow-md"
        >
          Purchase Now
          <svg
            xmlns="http://www.w3.org/2000/svg"
