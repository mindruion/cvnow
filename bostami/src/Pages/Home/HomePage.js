  ...
  return (
    <>
      ...
      >
        ...
        <button className="flex items-center gradient-theme gradient-theme-hover duration-200 transition ease-linear px-8 py-3 text-lg text-white rounded-[35px] mt-6">
