            ...
            >
              {data.slice(0, items).map((item, index) => (
                ...
                >
                  ...
                  <h2
                    onClick={() => handleModle(item.id)}
                    className="font-medium cursor-pointer text-xl duration-300 transition hover-text-theme-primary dark:text-white mt-2"
                  >
                    {item?.title}
                  </h2>
                </div>
            ...
            >
              <div className=" w-full md:w-10/12 flex items-center   lg:w-[850px] bg-white dark:bg-[#323232] mx-auto rounded-xl p-4 md:p-8 absolute left-1/2 top-1/2 transform -translate-x-[50%] -translate-y-[50%] shadow-lg ">
                <div className=" overflow-y-scroll max-h-[80vh] no-scrollbar ">
                  ...
                  />
                  <h2 className="text-theme-primary hover-text-theme-primary text-4xl text-center font-bold">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 my-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="dark:text-white flex items-center text-[15px] sm:text-lg ">
                        ...
                        Preview :&nbsp;
                        <span className="font-medium transition-all duration-300 ease-in-out hover-text-theme-primary ">
                          <a
